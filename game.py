...
value_str = ''
left_button_pressed_thisGame = False
right_button_pressed_thisGame = False
screen_width = 800
screen_height = 600
...
while is_game_running:
    ...
    if arduino1.in_waiting > 0:
        ...
        left_button_pressed_thisGame, right_button_pressed_thisGame = communication.button_state(data)
    ...
    if left_button_pressed_thisGame and player_1_x > 0:
        player_1_x -= player_1_speed
        left_button_pressed_thisGame = False
        
    #if keys[pygame.K_RIGHT] and player_1_x < screen_width - player_1_width:
    if right_button_pressed_thisGame and player_1_x > 0:
        player_1_x += player_1_speed
        right_button_pressed_thisGame = False
